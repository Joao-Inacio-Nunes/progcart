...
% Slide 5
\begin{frame}[fragile]{Instalação com Docker}
\textbf{Baixar, criar o container e executar o serviço ollama.}
\begin{minted}{bash}
docker run -d -p 11434:11434 ollama/ollama:latest --name ollama
\end{minted}
\textbf{Parar ou iniciar (depois de criado)}
\begin{minted}{bash}
docker start ollama
docker stop ollama
\end{minted}

\textbf{Baixar um modelo de linguagem. \href{https://ollama.com/search}{Lista de mmodelos}.}
\begin{itemize}
\item LiquidAI/lfm2.5-1.2b-instruct
\item gemma4
\end{itemize}
\begin{minted}{bash}
docker exec -it ollama ollama pull LiquidAI/lfm2.5-1.2b-instruct
\end{minted}

\textbf{Iniciar o servidor de modelos de linguagem.}
\begin{minted}{bash}
...
% Slide 6
\begin{frame}[fragile]{Baixando um Modelo}
...
% Slide 7
\begin{frame}[fragile]{Executando o Modelo}
Via CLI:
...
% Slide 9
\begin{frame}[fragile]{Gerenciamento de Modelos}
    \begin{itemize}
        \item Listar modelos:
\begin{minted}{bash}
ollama list
...
% Slide Extra
\begin{frame}[fragile]{Controle do Ollama com Open WebUI}
